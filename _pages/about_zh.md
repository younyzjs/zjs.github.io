...
&emsp;&emsp;在中国科学院自动化所NLPR实验室，我参与研究**高效的大规模工具令牌化和生成式调用**，针对工具智能体（**Tool Agent**）数据稀缺问题，构建万级多模态Tool数据集，优化Toolkengpt模型的工具理解能力，相关成果以第四作者在投CCF-A类会议ACL。我参与**DeepSeek-R1微调**研究，依据MoleculeNet数据构建1.77M微调数据集，在分类任务达到平均98.95%的准确率。此外，我通过大模型实战训练营取得**CSTP大模型应用开发工程师**技能证书，为技术落地奠定基础。
