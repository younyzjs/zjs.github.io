...
- At CASIA NLPR Lab: Participated in the research of **LToGc: Efficient Large-scale Tool Tokenization and Generative Calling** ,built 46K+ multimodal **Tool Agent** dataset to enhance Toolkengpt's tool comprehension,Related achievements are submitted as the forth author to the CCF-A conference ACL; Contributed to **DeepSeek-R1** molecular classification model achieving 98.95% accuracy on MoleculeNet.
